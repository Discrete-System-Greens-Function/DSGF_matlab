function save_DSGF_TRANS_matrix(output, filePath_st, specific_omega, DSGF_matrix, Trans_coeff_matrix)
...
%		specific_omega - omega at which the matrices were calculated
