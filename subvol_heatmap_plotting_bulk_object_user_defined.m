function subvol_heatmap_user_defined(r, L_sub, Q_total_subvol, c_limits, show_axes, output, saveDir, N, N1)
...
%		output - save the figure or not
	...
	[vert, fac] = voxel_image( r(1:N_ref,:), L_sub(1), [], [], [], [], 'heatmap', Q_total_subvol(:,1:N_ref), c_limits );
    [vert, fac] = voxel_image( r(N_ref+1:N1,:), L_sub(N1), [], [], [], [], 'heatmap', Q_total_subvol(:,N_ref+1:N1), c_limits );
    [vert, fac] = voxel_image( r(N1+1:N-N_ref,:), L_sub(N1+1), [], [], [], [], 'heatmap', Q_total_subvol(:,N1+1:N-N_ref), c_limits );
    [vert, fac] = voxel_image( r(N-N_ref+1:N,:), L_sub(N), [], [], [], [], 'heatmap', Q_total_subvol(:,N-N_ref+1:N), c_limits );
