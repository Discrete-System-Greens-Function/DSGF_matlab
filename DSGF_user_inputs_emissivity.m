...
%The user must decide whether to calculate thermal conductance or thermal emissivity 
output.emissivity = true;
...
DSGF_Thermal_Emission(description, discretization, material, T_equilibrium, epsilon_ref, omega, output, spatial_discretization_type, L_char, delta_V, d);
end
